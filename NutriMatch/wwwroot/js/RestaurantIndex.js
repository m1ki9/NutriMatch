...
function areFiltersDefault() {
    return currentFilters.calories.min === 0 && currentFilters.calories.max === 1000 &&
            currentFilters.protein.min === 0 && currentFilters.protein.max === 100 &&
            currentFilters.carbs.min === 0 && currentFilters.carbs.max === 150 &&
            currentFilters.fats.min === 0 && currentFilters.fats.max === 100;
}
...
console.log('Fetching URL:', `/Restaurants/GetRestaurantMeals/${restaurantId}?${query}`);
